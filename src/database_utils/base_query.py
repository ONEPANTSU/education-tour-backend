...
class AbstractBaseQuery(ABC):
    ...
    @abstractmethod
    def __int__(self, models: BaseModels = BaseModels):
        self._schema_create_class: type = models.create_class
        self._schema_update_class: type = models.update_class
        self._schema_read_class: type = models.read_class
        self._model: type = models.database_table
    ...
    ) -> Optional[List[_schema_read_class]]:
        pass

    @abstractmethod
    async def get_by_id(
        self, model_id: int, session: AsyncSession
    ) -> Optional[_schema_read_class]:
        pass
